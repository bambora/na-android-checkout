...
public class ShippingFragment extends AddressFragment {
    ...
    private final static String EXTRA_BILLING_REQUIRED = "com.bambora.na.checkout.models.options.billingrequired";
    private final static String EXTRA_BILLING_SAME_AS_SHIPPING = "com.bambora.na.checkout.billing.sameas.shipping";
